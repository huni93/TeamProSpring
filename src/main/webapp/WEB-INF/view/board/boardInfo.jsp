...
function openPurchasePopup() {
    ...
    if (buyAmount !== null) {
        ...
        if (!isNaN(buyAmount)) {
            ...
            //    alert("0")
             // location.href = "${pageContext.request.contextPath}/board/buyPro?pnum=${board.pnum}&buy=" + buyAmount + "&buyid=${amem.id}";
              test = "${pageContext.request.contextPath}/board/buyPro111?pnum=${board.pnum}&buy=" + buyAmount + "&buyid=${amem.id}";
              alert(test)
